...
export declare const basicTimeSpinnerProps: {
    ...
    readonly disabledHours: {
        readonly type: import("vue").PropType<(role: string, comparingDate?: Dayjs | undefined) => number[]>;
        readonly required: false;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
    readonly disabledMinutes: {
        readonly type: import("vue").PropType<(hour: number, role: string, comparingDate?: Dayjs | undefined) => number[]>;
        readonly required: false;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
    readonly disabledSeconds: {
        readonly type: import("vue").PropType<(hour: number, minute: number, role: string, comparingDate?: Dayjs | undefined) => number[]>;
        readonly required: false;
        readonly validator: ((val: unknown) => boolean) | undefined;
        __epPropKey: true;
    };
